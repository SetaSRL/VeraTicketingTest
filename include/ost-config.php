...
define('SECRET_SALT','BCvGyNQvYasCVutA8o4H7uoH5nH7AAt3');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','erosselli@setagroup.it');
...
define('DBHOST','31.11.39.145:3306');
define('DBNAME','Sql1690202_1');
define('DBUSER','Sql1690202');
define('DBPASS','Siamobellibelli1!');
